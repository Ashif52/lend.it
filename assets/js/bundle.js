(function (exports) {
	...
	function OrbitingCircles(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: cn$1("absolute inset-0 flex items-center justify-center", className),
	    style: {
	      "--radius": radius
	    }
	    ...
	    }, "width", "calc(var(--radius, " + radius + ") * 2px)"), "height", "calc(var(--radius, " + radius + ") * 2px)"), "border", "1px solid rgba(255, 255, 255, 0.3)"), "zIndex", 0)
	  }), React.Children.map(children, function (child, index) {
	    var angle = 360 / React.Children.count(children) * index;
	    var animDelay = duration / speed * (angle / 360);
	    var animDirection = reverse ? 'reverse' : 'normal';
	    return /*#__PURE__*/React.createElement("div", {
	      style: {
	        "--icon-size": "".concat(iconSize, "px"),
	        animation: "orbit ".concat(duration / speed, "s linear infinite ").concat(animDirection),
	        animationDelay: "-".concat(animDelay, "s"),
	        position: "absolute",
	        top: "50%",
	        left: "50%",
	        marginTop: "-".concat(iconSize / 2, "px"),
	        marginLeft: "-".concat(iconSize / 2, "px"),
	        zIndex: 10
	      },
	      className: cn$1("flex size-[var(--icon-size)] items-center justify-center rounded-full border border-white/10 bg-black/20 backdrop-blur-sm")
	    }, child);
	  }));
	}
	...
	*/
	...
	function Globe(_ref) {
	  var className = _ref.className,
	    ...
	    config = _ref$config === void 0 ? GLOBE_CONFIG : _ref$config;
	  var canvasRef = reactExports.useRef(null);
	  var phiRef = reactExports.useRef(0);
	  var widthRef = reactExports.useRef(0);
	  var pointerInteracting = reactExports.useRef(null);
	  var pointerInteractionMovement = reactExports.useRef(0);
	  var r = useMotionValue(0);
	  var rs = useSpring(r, {
	    mass: 1,
	    damping: 30,
	    stiffness: 100
	  });
	  var updatePointerInteraction = function updatePointerInteraction(value) {
	    pointerInteracting.current = value;
	    if (canvasRef.current) {
	      canvasRef.current.style.cursor = value !== null ? "grabbing" : "grab";
	    }
	  };
	  var updateMovement = function updateMovement(clientX) {
	  ...
	  reactExports.useEffect(function () {
	    ...
	    onResize();
	    var globe = _t(canvasRef.current, _objectSpread2(_objectSpread2({}, config), {}, {
	      width: widthRef.current * 2,
	      height: widthRef.current * 2,
	      onRender: function onRender(state) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: cn$1("absolute inset-0 mx-auto aspect-square w-full max-w-[600px] border-none shadow-none bg-transparent", className)
	  }, /*#__PURE__*/React.createElement("canvas", {
	    className: cn$1("h-full w-full opacity-0 transition-opacity duration-500 border-none outline-none ring-0"),
	    ref: canvasRef,
	    ...
	    onPointerUp: function onPointerUp() {
	      return updatePointerInteraction(null);
	    },
	    onPointerOut: function onPointerOut() {
	      return updatePointerInteraction(null);
	    },
	    onMouseMove: function onMouseMove(e) {
	      return updateMovement(e.clientX);
	    },
	...
	function DottedMap(_ref) {
	  var _ref$width = _ref.width,
	    width = _ref$width === void 0 ? 150 : _ref$width,
	    _ref$height = _ref.height,
	    height = _ref$height === void 0 ? 75 : _ref$height,
	    _ref$mapSamples = _ref.mapSamples,
	    mapSamples = _ref$mapSamples === void 0 ? 5000 : _ref$mapSamples,
	    _ref$markers = _ref.markers,
	    markers = _ref$markers === void 0 ? [] : _ref$markers,
	    _ref$markerColor = _ref.markerColor,
	    markerColor = _ref$markerColor === void 0 ? "#FF6900" : _ref$markerColor,
	    _ref$dotRadius = _ref.dotRadius,
	    dotRadius = _ref$dotRadius === void 0 ? 0.2 : _ref$dotRadius,
	    _ref$stagger = _ref.stagger,
	    stagger = _ref$stagger === void 0 ? true : _ref$stagger,
	  ...
	  var _createMap = r1({
	    ...
	    points = _createMap.points,
	    addMarkers = _createMap.addMarkers;
	  var processedMarkers = addMarkers(markers);
	  ...
	  var _React$useMemo = reactExports.useMemo(function () {
	    ...
	    xStep = _React$useMemo.xStep,
	    yToRowIndex = _React$useMemo.yToRowIndex;
	  return /*#__PURE__*/reactExports.createElement("svg", _extends({
	    ...
	    var _yToRowIndex$get;
	    var rowIndex = (_yToRowIndex$get = yToRowIndex.get(point.y)) !== null && _yToRowIndex$get !== void 0 ? _yToRowIndex$get : 0;
	    var offsetX = stagger && rowIndex % 2 === 1 ? xStep / 2 : 0;
	    return /*#__PURE__*/reactExports.createElement("circle", {
	      cx: point.x + offsetX,
	      cy: point.y,
	      r: dotRadius,
	      fill: "currentColor",
	      key: "dot-".concat(point.x, "-").concat(point.y, "-").concat(index)
	    });
	  }), processedMarkers.map(function (marker, index) {
	    var _yToRowIndex$get2, _marker$size, _marker$size2;
	    var rowIndex = (_yToRowIndex$get2 = yToRowIndex.get(marker.y)) !== null && _yToRowIndex$get2 !== void 0 ? _yToRowIndex$get2 : 0;
	    var offsetX = stagger && rowIndex % 2 === 1 ? xStep / 2 : 0;

	    // Custom rendering for LendIt marker to make it pulse
	    return /*#__PURE__*/reactExports.createElement("g", {
	      key: "marker-".concat(marker.x, "-").concat(marker.y, "-").concat(index)
	    }, /*#__PURE__*/reactExports.createElement("circle", {
	      cx: marker.x + offsetX,
	      cy: marker.y,
	      r: ((_marker$size = marker.size) !== null && _marker$size !== void 0 ? _marker$size : dotRadius) * 4,
	      fill: markerColor,
	      opacity: "0.2",
	      ...
	      cx: marker.x + offsetX,
	      cy: marker.y,
	      r: (_marker$size2 = marker.size) !== null && _marker$size2 !== void 0 ? _marker$size2 : dotRadius * 1.5,
	      fill: markerColor
	    }));
	  }));
	}
	...
	// 1. Render Hero Globe
	var globeRootElement = document.getElementById('hero-globe');
	if (globeRootElement) {
	  var globeRoot = clientExports.createRoot(globeRootElement);
	  globeRoot.render(/*#__PURE__*/React.createElement(HeroGlobe, null));
	}
	...
	function OrbitingCirclesDemo() {
	  return /*#__PURE__*/React.createElement("div", {
	  ...
	  }, /*#__PURE__*/React.createElement(OrbitingCircles, {
	    iconSize: 40,
	    radius: 120,
	    className: "inner-orbit"
	  }, /*#__PURE__*/React.createElement(Bike, {
	    ...
	    className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-bold text-3xl z-20 whitespace-nowrap"
	  }, "LendIt"), /*#__PURE__*/React.createElement("div", {
	    className: "absolute top-1/2 left-1/2 -translate-x-1/2 translate-y-6 text-white/50 text-base z-20 text-center w-80 whitespace-nowrap"
	  }, "Connected by people's"));
	}
	var orbitingRootElement = document.getElementById('orbiting-effect');
	if (orbitingRootElement) {
	  var orbitingRoot = clientExports.createRoot(orbitingRootElement);
	  orbitingRoot.render(/*#__PURE__*/React.createElement(OrbitingCirclesDemo, null));
	}

	// 3. Render Dotted Map Section (India-only glowing markers)
	var dottedMapRootElement = document.getElementById('dotted-map-container');
	if (dottedMapRootElement) {
	  var dottedMapRoot = clientExports.createRoot(dottedMapRootElement);
	  dottedMapRoot.render(/*#__PURE__*/React.createElement(DottedMap, {
	    markerColor: "#a855f7",
	    dotColor: "#ffffff20",
	    dotRadius: 0.4,
	    markers: [{
	...
	exports.OrbitingCirclesDemo = OrbitingCirclesDemo;
