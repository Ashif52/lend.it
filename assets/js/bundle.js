(function (exports) {
	...
	function OrbitingCircles(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    ...
	    return /*#__PURE__*/React.createElement("div", {
	      ...
	      className: cn("flex size-[var(--icon-size)] items-center justify-center rounded-full border border-white/10 bg-black/20 backdrop-blur-sm")
	    }, child);
	  }));
	}
	...
	*/
	...
	function Globe(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: cn("absolute inset-0 mx-auto aspect-square w-full max-w-[600px] border-none shadow-none bg-transparent", className)
	  }, /*#__PURE__*/React.createElement("canvas", {
	    className: cn("h-full w-full opacity-0 transition-opacity duration-500 border-none outline-none ring-0"),
	    ref: canvasRef,
